            ...
            ${this.backups.map(t=>L`
              <div class="backup-row">
                <div class="table-row">
                  ...
                  <div class="cell-duration">${function(t){if(!yt(t))return"Invalid duration";if(0===t)return"0s";const e=Math.floor(t/3600),r=Math.floor(t%3600/60),s=Math.floor(t%60),i=[];return e>0&&i.push(`${e}h`),r>0&&i.push(`${r}m`),(s>0||0===i.length)&&i.push(`${s}s`),i.join(" ")}(t.duration)}</div>
                  <div class="cell-outcome">
                    <outcome-badge .outcome=${t.outcome}></outcome-badge>
                  </div>
                </div>
